...
%   Output:
%       Unified folders 'SimH_RTM_Set', 'SimH_DTM_Set', and 'SimH_RDM_Set' containing sequentially numbered PNGs.
%
% Source Directories:
%   SimH_RTM_Set_PSNR, SimH_DTM_Set_PSNR, SimH_RDM_Set_PSNR
%   SimH_RTM_Set_TRGS, SimH_DTM_Set_TRGS, SimH_RDM_Set_TRGS
...
Source_Dirs.RTM_PSNR = "SimH_RTM_Set_PSNR";
Source_Dirs.DTM_PSNR = "SimH_DTM_Set_PSNR";
Source_Dirs.RDM_PSNR = "SimH_RDM_Set_PSNR";

Source_Dirs.RTM_TRGS = "SimH_RTM_Set_TRGS";
Source_Dirs.DTM_TRGS = "SimH_DTM_Set_TRGS";
Source_Dirs.RDM_TRGS = "SimH_RDM_Set_TRGS";

% Output directory settings
Output_Dirs.RTM = "SimH_RTM_Set";
Output_Dirs.DTM = "SimH_DTM_Set";
Output_Dirs.RDM = "SimH_RDM_Set";
