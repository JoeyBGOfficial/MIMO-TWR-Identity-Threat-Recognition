...
%
% Description:
%   1 Loads RTF Point Cloud datasets from .mat files in Measured_RTFPointSet.
...
% --- Path Parameters ---
data_root = 'Measured_RTFPointSet';
...
train_ratio = 0.8;
batch_size = 32;
max_epochs = 500;                                                           % Sufficient epochs for convergence
...
fprintf('Improved PointConv Network Measured Complete.\n');